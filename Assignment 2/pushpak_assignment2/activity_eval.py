...
#Assigning the evaluation strategy to the classifier and then averaging the mean of the array of calculated accuracy per fold of kfold
...
#Calculating average of the errors found in each strategy per classifier
a = [accuracy_4_a_tree - accuracy_5_tree, accuracy_4_a_ranFor - accuracy_5_ranFor,  accuracy_4_a_knnc - accuracy_5_knnc, accuracy_4_a_mlp - accuracy_5_mlp]
avga = sum(a) / len(a)

b = [kfold_score_tree - accuracy_5_tree, kfold_score_ranFor- accuracy_5_ranFor,  kfold_score_knnc - accuracy_5_knnc, kfold_score_mlp - accuracy_5_mlp]
avgb = np.mean(b)

c = [skfold_score_tree - accuracy_5_tree, skfold_score_ranFor- accuracy_5_ranFor, skfold_score_knnc - accuracy_5_knnc,  skfold_score_mlp - accuracy_5_mlp]
avgc = np.mean(c)

d = [ gkfold_score_tree - accuracy_5_tree, gkfold_score_ranFor- accuracy_5_ranFor, gkfold_score_knnc - accuracy_5_knnc, gkfold_score_mlp - accuracy_5_mlp]
avgd = np.mean(d)

e = [sgkfold_score_tree - accuracy_5_tree, sgkfold_score_ranFor- accuracy_5_ranFor, sgkfold_score_knnc - accuracy_5_knnc,  sgkfold_score_mlp - accuracy_5_mlp]
avge = np.mean(e)
